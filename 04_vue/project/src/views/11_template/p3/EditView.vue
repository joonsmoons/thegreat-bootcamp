<template>
  <div class="mt-3">
    ...
    <button class="btn btn-secondary me-2" @click="goToDetail">Back</button>
    <button class="btn btn-success me-2" @click="doEdit">Save</button>
    <button class="btn btn-danger me-2" @click="doDelete">Delete</button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    goToDetail() {
      this.$router.push(`/template/p3/detail/${this.id}`)
    },
    goToList() {
